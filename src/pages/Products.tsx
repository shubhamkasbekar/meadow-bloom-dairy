  ...
  return (
    <div className="min-h-screen bg-dairy-light-accent py-12">
      <div className="container mx-auto px-4">
        <h1 className="text-3xl font-bold mb-8 text-center text-dairy-primary">
          Our Products
        </h1>
        ...
        <div className="mb-8 grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="font-semibold text-lg mb-4 text-dairy-primary">
              Categories
            </h3>
            ...
            >
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="basundi" id="basundi" />
                  <Label htmlFor="basundi">Basundi</Label>
                </div>
                <div className="flex items-center space-x-2">
          ...
          <div className="lg:col-span-3">
            {filteredProducts.length > 0 ? (
              ...
              <div className="bg-white p-10 rounded-lg text-center">
                <h3 className="text-xl font-semibold mb-2 text-dairy-primary">
                  No products found
                </h3>
